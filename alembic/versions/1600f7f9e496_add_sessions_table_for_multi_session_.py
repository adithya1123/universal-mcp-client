"""add sessions table for multi-session management

Revision ID: 1600f7f9e496
Revises: 
Create Date: 2025-10-13 12:07:27.720884
...
def upgrade() -> None:
    ...
    op.alter_column('langgraph_checkpoints', 'created_at',
               existing_type=postgresql.TIMESTAMP(),
               type_=postgresql.TIMESTAMP(timezone=True),
               existing_nullable=False)
    op.alter_column('mcp_servers', 'last_health_check',
               existing_type=postgresql.TIMESTAMP(),
               type_=postgresql.TIMESTAMP(timezone=True),
